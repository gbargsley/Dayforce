# Overwrite Deploy-AdminDB.ps1 with a clean UTF8 file (no BOM)
$targetPath = 'F:\temp\GB\Ola\Deploy\Deploy-AdminDB.ps1'
...
<#
 ...
 - Renames existing dbo.DatabaseBackup -> DatabaseBackup_glb (if found).
...
param(
    ...
    [string]$SqlFile = "F:\ola\DatabaseBackup.sql",
...
$script | Out-File -FilePath $targetPath -Encoding utf8 -Force

Write-Host "Wrote cleaned script to $targetPath (UTF8, no BOM)."
'
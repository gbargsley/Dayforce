...
/****** Object:  Job [MS - SQL_Server_LogScout]    Script Date: 1/27/2026 4:29:34 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [MS Monitoring Health]    Script Date: 1/27/2026 4:29:35 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update Output FileName]    Script Date: 1/27/2026 4:29:36 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect PerfStats]    Script Date: 1/27/2026 4:29:36 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Collect PerfStats', 
		...
		@database_name=N'SR2511100040010255', 
		@output_file_name=N'D:\MSDiagnosticDataCapture\PerfStats_azm1dfcsql04d_20260115_1400.out', 
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect MemStats]    Script Date: 1/27/2026 4:29:36 PM ******/
...
BEGIN 
	EXEC SR2511100040010255.dbo.sp_Run_MemStats ''0:2:0''
END 
', 
		@database_name=N'SR2511100040010255', 
		@output_file_name=N'D:\MSDiagnosticDataCapture\Mem_Stats_azm1dfcsql04d_20260115_1400.out', 
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Clear Job history]    Script Date: 1/27/2026 4:29:36 PM ******/
...
END ', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge Logs Older than 24 hours]    Script Date: 1/27/2026 4:29:36 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Purge Logs Older than 24 hours', 
		@step_id=5, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Collect Ev 10 sec', 
		...
		@schedule_uid=N'c93d8330-f7e9-467a-a582-9d626b2959e3'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
